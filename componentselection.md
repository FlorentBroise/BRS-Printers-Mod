...
**1204 POS2 ARMS**|![alt text](/image/arm31.png)<br>SFU1204 Version - Allow to be mounted with the 3.1 rails positions (rear of the front Z 3030). Opening the ZU1.x and 2.0a to the Official Ratrig 2.0 Enclosure kit.|20/02/23| [STEP](https://github.com/FlorentBroise/BRS-Printers-Mod/raw/main/cad/ARM31.step) | / | / |![alt text](/image/license.png)|
...
**V2.05b ZU2.x 3mm Spacer**|![alt text](/image/3mmSPACER.png)A spacer to be used if no enclosure bottom plate is placed.|08/05/23| [3MF](https://github.com/FlorentBroise/BRS-Printers-Mod/raw/main/cad/3mmSPACER.3mf) | / | / |![alt text](/image/license.png)|[SHOP](https://store.brs-engineering.com/products/z-upgrade-2-0-vcore-3-x)
**V2.05b ZU2.x 75mm Feet v1.0**|![alt text](/image/feet.png)4x 75 feet to adapt the Z-Upgrade 2.0 on the stock frame of any Vcore 3.0/3.1.|12/06/23| [STEP](https://github.com/FlorentBroise/BRS-Printers-Mod/raw/main/cad/ZUfeet.step) | [3MF](https://github.com/FlorentBroise/BRS-Printers-Mod/raw/main/cad/feet.zip) | / ||[SHOP](https://store.brs-engineering.com/products/pieds-x4-pour-vcore-3)
...
**V2.07a Heavy Duty 1204 3.1 Top**|![alt text](/image/top31.png)Replace the top front section with the ballscrew top retainer for the last VCORE 3.1 idle plates. Available for stock M5 screw and Precision shoulder bolt. Replace the old stock ZU2.0 BRS open front design since the 04/07/23|04/07/23| / | | / ||[SHOP](https://store.brs-engineering.com/products/z-upgrade-2-0-vcore-3-x)
**V2.08a Heavy Duty 1204 3.1 Top**|Add a safety bumper for the MGN carriage|05/07/23| [STEP](https://github.com/FlorentBroise/BRS-Printers-Mod/raw/main/cad/BRS-Open-Front-31.zip) | | / ||[SHOP](https://store.brs-engineering.com/products/z-upgrade-2-0-vcore-3-x)
...
Version|Description|ReleaseDate|CAD|Files|License|ShOP
-------------|-----------|-----------|-----------|------------|-----------|-----------
...
**vb3.3**(ACTIVE)| TOP Rail ( EVA ) - Iteration to adapt natively on stock Ratrig VC3.0 plates, or CF version from 3rd party vendors AVAILABLE for Print service at BRS-E (Prefer a Z1 preload MGN9H)<br> |26/06/2022|[STEP/STL](https://github.com/FlorentBroise/BRS-Printers-Mod/raw/main/cad/Ultralight-Joiner-CF-Adjusted.zip)||![alt text](/image/license.png)|[SHOP](https://www.brs-engineering.com/Flathead-Toolhead.html)
**vb3.4**(DEPRECATED)|  TOP Rail ( VZ bot ) - SHOULDER BOLT/M5 - Iteration to maximize X dimension for the VZbot Printhead, (Prefer a Z1 preload MGN9H ONLY)<br> |27/06/2022|[STL](https://github.com/FlorentBroise/BRS-Printers-Mod/raw/main/cad/Ultralight-Joiner-CF-Adjusted2.zip) / [STEP](https://github.com/FlorentBroise/BRS-Printers-Mod/raw/main/cad/Ultralight-Joiner-CF-Adjusted3.zip)||![alt text](/image/license.png)|
**vb3.5a**(Active)| ![alt text](/image/gantry10.png) TOP Rail ( VZ bot ) - SHOULDER BOLT - Iteration to maximize X dimension for the VZbot Printhead,  !!FOR VC3.1<br> |12/09/2022|[STEP](https://github.com/FlorentBroise/BRS-Printers-Mod/raw/main/cad/VC31SBstd.zip)|||Print Service[SHOP](https://store.brs-engineering.com/products/vcore-joiners-for-vz-toolhead)
**vb3.5b**(Active)| ![alt text](/image/gantry11.png) TOP Rail ( VZ bot ) - M5 - Iteration to maximize X dimension for the VZbot Printhead, M5 Stock fixation, !! FOR VC3.1<br> |12/09/2022|[STEP](https://github.com/FlorentBroise/BRS-Printers-Mod/raw/main/cad/VC31std.zip)|||Print Service[SHOP](https://store.brs-engineering.com/products/vcore-joiners-for-vz-toolhead)
**vb3.5c**(Active)| ![alt text](/image/gantry12.png) TOP Rail ( VZ bot ) - SHOULDER BOLT - Iteration to maximize X dimension for the VZbot Printhead, More stable Join than 3.4 version, ready for Optical X endstop. Low weight (20g/each with PA12CF15) (Prefer a Z1 preload MGN9H) !! FOR VC3.0 and BRS-VULCAIN<br> |12/09/2022|[STEP](https://github.com/FlorentBroise/BRS-Printers-Mod/raw/main/cad/VC30VULC.zip)||![alt text](/image/license.png)|[SHOP](https://store.brs-engineering.com/products/vcore-joiners-for-vz-toolhead)
...
**PMB2.0a**|![alt text](/image/tensionner5.png)<br> PMB with L3VER tensionner incorporate, for stock Vcore3 (Open VZbot toolhead design)|10/06/2022 |[CAD is available on the STORE](https://store.brs-engineering.com/products/tendeur-l3ver-m2-a1-0-cad)|[BOM](https://github.com/FlorentBroise/BRS-Printers-Mod/blob/main/bom/BOM-M1-M2.pdf)|![alt text](/image/by-nc-nd.png)|[SHOP](https://www.brs-engineering.com/Heavy-duty-motor-block.html)
**PMB2.0b**|PMB with L3VER tensionner incorporate, for open front mod (Open to VZbot toolhead design)|10/06/2022 |[CAD is available on the STORE](https://store.brs-engineering.com/products/tendeur-l3ver-m2-a1-0-cad)|[BOM](https://github.com/FlorentBroise/BRS-Printers-Mod/blob/main/bom/BOM-M1-M2.pdf)|![alt text](/image/by-nc-nd.png)|[SHOP](https://www.brs-engineering.com/Heavy-duty-motor-block.html)
**SKL-1.0**|![alt text](/image/skeleton.png)<br>Top plate for the L3VER M2 tensionner. Generated with topology study, allow a very light part, and an original open heart skeleton design.|07/09/2022 |[STEP](/cad/SKL-1-M2.zip)|[BOM](https://github.com/FlorentBroise/BRS-Printers-Mod/blob/main/bom/BOM-M1-M2.pdf)|![alt text](/image/by-nc-nd.png)|[SHOP](https://florent-broise.myshopify.com/products/l3ver-m2-skeleton-top)
...
Version|Description|ReleaseDate|CAD|BOM|License|Order
-------------|-----------|-----------|-----------|-----------|-----------|-----------
**BOF-V1**|![alt text](/image/OpenF.png)<br> Replace the stock idler, allow to remove the front 3030 extrusion to clear the view. Intended to be use with the Z-Ugrade (all versions), with EVA tensionner system OR with the upcoming L3VER M tensionner for the VC3; Needs 6x M6x20 and 2 5x55m steel shafts |19/05/2022 |[R](/cad/stl/OFR.stl) [L](/cad/stl/OFL.stl) | |![alt text](/image/license.png)| [SHOP](https://florent-broise.myshopify.com/products/open-front-idlers)
**BOF-V1**|![alt text](/image/bof2.png)<br> Replace the stock idler, allow to remove the front 3030 extrusion to clear the view. Intended to be use with the 3.1/3.1/Ventermech versions, with EVA tensionner system OR with the upcoming L3VER M tensionner for the VC3; Needs 6x M6x20 and 2 5x55m steel shafts |07/11/2022 |[U](/cad/xy_idler_v1.2_W.step) | |![alt text](/image/license.png)| [SHOP](https://florent-broise.myshopify.com/products/open-front-idlers)
**BOF-Modular-V2**|![alt text](/image/OpenF2.png)<br> Replace the stock idler, allow to remove the front 3030 extrusion to clear the view. Intended to be use with the Z-Ugrade (all versions), with EVA tensionner system OR with the L3VER M Series tensionner for the VC3. Made for the VC3.0/3.1, compatible with the 2.0 Enclosure, and have the flexibility to be used with: the stock 3.1 leadscrews jigs, the Z-Upgrade 1.6-1.99 SFU retainers , and the upcoming VULCAIN variation |20/10/2022 |[Universal STEP (mirror it)](/cad/BOF2.step)| |![alt text](/image/license.png)| [SHOP](https://florent-broise.myshopify.com/products/brs-open-front-idlers-v2-0)
...
-------------|-----------|-----------|-----------|------------|------------|-----------
**V1.0-VZ-MosquitoM+**|![alt text](/image/mosquitom.PNG)| | [STEP](/cad/Flatheadv2.zip)|16/01/23||[SHOP](https://store.brs-engineering.com/products/eva-3-x-cartesian-inserts-magnum-plus-vz-extruder2)
**V1.0-M+ Duct Corrected**|![alt text](/image/mosquitomduct.PNG)| | [3MF](/cad/MplusDuct.3mf) |25/01/23||[SHOP](https://store.brs-engineering.com/products/eva-3-x-cartesian-inserts-magnum-plus-vz-extruder2)
...
**V0.21-BRS-HextrudORT BETA**|| Euclid Probe version, can be equiped with every hotend variation from the [Hevort Page](https://miragec79.github.io/HevORT/), be careful to the Z probe Height, compatible with the new Gantry V2 | [Files](/cad/toolheadv3.step)|22/03/22|![alt text](/image/by.png)
