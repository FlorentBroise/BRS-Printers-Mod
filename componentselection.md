...
**BOF-Modular-V2**|![alt text](/image/OpenF2.png)<br> Replace the stock idler, allow to remove the front 3030 extrusion to clear the view. Intended to be use with the Z-Ugrade (all versions), with EVA tensionner system OR with the L3VER M Series tensionner for the VC3. Made for the VC3.0/3.1, compatible with the 2.0 Enclosure, adn have the flexibility toi be used with: the stock 3.1 leadscrews jigs, the Z-Upgrade 1.6-1.99 SFU retainers , and the upcoming VULCAIN variation |20/10/2022 |[Universal STEP (mirror it)](/cad/BOF2.step)| |![alt text](/image/license.png)| [SHOP](https://florent-broise.myshopify.com/products/brs-open-front-idlers-v2-0)
