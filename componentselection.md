...
**V1.99-2 Heavy Duty EXTENDED**|![alt text](/image/Complete7.png)<br>Drop in upgrade for existing Z-Upgrade, or new complete kit: Extend the Z distance of 50mm (need of 50mm longer ballscrews spindles. Use the same Plates pattern than the previous ZU versions, available for 2-3-4mm underplates otherwise through height modualator. Corner completly reinforced and high ability to keep the frame aligned fro the spindle Axis, use the same Arms, Oldham and Retainer than previous Z upgrade version. Compatible natively for NEMA 17 and NEMA 23. Need a 50mm (Depending NEMA size) of clearance bellows the frame, Compatible with every VCore 3.x machines, scalable for VC600-1000|20/11/22|20/11/22| Soon |Soon|![alt text](/image/license.png)|Soon
**V2.0 Heavy Duty-POC**|![alt text](/image/Complete6.png)<br>SFU1605 Ballscrews and oldham 3.0 system. New bed arms for non planar full compliance and higher angular motions For Heavier custom cast aluminium Bed and NEMA24 / NEMA17 motion (used with feet), for bigger machine (VC700, 1000, etc) or even a 300|...|Q4 22| To come||![alt text](/image/license.png)
