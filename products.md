...
BRS-E L3VER M1 1.1 (A1.6) Tensionner module|Active|![alt text](/image/tensionner71.png)<br> **L3VER M1 1.1 A1 Tensionner** A full Vcore 3 compatible manual tensionner block removing the need of the EVA tensionner, can open the compatibility for the upcomming VZ-Bot Al/CF Toolhead set, and the next Flathead V3 iteration. NEED D5M4 Shoulder bolt, This is a revised version from the 1.0, more dense, few parts less, same performances|[Download](/manuals/Manual-Tensionner-L3VER-M1-A.pdf)|01/05/23| [SHOP Soon]()|[Shop CAD Soon]()| ![alt text](/image/by-nc-nd.png)

### L3VER M2 TENSIONNER enclosure plates Vcore 3.x (3.0 / 3.1)
Rear part is meant to be printed, the front one is to be cut (metal/PC)
...
--------|------|---------------------|----|--------------- |--------------|---------------|---------------
M2/WS7040 CPAP V0 - Enclosure plates|Deprecated|![alt text](/image/m2-plate-cpap.png)<br> **M2/WS7040 CPAP - Enclosure plates** A set of plates to close the rear electronic top for the M2 Lever. Has been designed with the Cpap hole but can be use with any layout you can add; This iteration use the excellent mod from my friend Dan Cernogorsky, named "RatRig V-Core WS7040 CPAP Fan Shelf Mount", housing the CPAP fan and electronic in a dampered solution meant to reduce the sound of the turbofan, and ease the mounting of it. Made for Vcore 3.x 200mm, 300mm, 400mm, 500mm, and 600mm|soon|24/05/23|Soon|[CAD](/cad/CPAP-Plate.zip)|[CREDIT](https://www.printables.com/model/354374-ratrig-v-core-ws7040-cpap-fan-shelf-mount/files) | 
M2/WS7040 CPAP Cutted V0.1 - Enclosure plates|Deprecated|<br> **M2/WS7040 CPAP - Enclosure plates**  Cutted version to be able to print it on small machines, the notches are used to slide both part inside, you can use cyanoacrylate glue to bond them (offset already applyied for printing)|Soon|30/05/23|Soon||[CREDIT](https://www.printables.com/model/354374-ratrig-v-core-ws7040-cpap-fan-shelf-mount/files) | 
M2/WS7040 CPAP Cutted v0.2- Enclosure plates|Deprecated|<br> **M2/WS7040 CPAP - Enclosure plates** Revision to add a Belt XY recess and a custom Y endstop holder? and a small cutout adjusment|Soon|12/02/23|Soon||[CREDIT](https://www.printables.com/model/354374-ratrig-v-core-ws7040-cpap-fan-shelf-mount/files) | 
M2/WS7040 CPAP Cutted v0.3- Enclosure plates|Active|<br> **M2/WS7040 CPAP - Enclosure plates** 2nd Revision to correct huge design flaw resulting a M2 misfitment|Soon|14/02/23|Soon|[CAD](/cad/m2-plate-cutted.step)|[CREDIT](https://www.printables.com/model/354374-ratrig-v-core-ws7040-cpap-fan-shelf-mount/files) | 
...
--------|------|---------------------|----|--------------- |--------------|---------------|---------------|---------------
M1+refreshed Enclosure plates 1.0|Active|![alt text](/image/m1-plate.png)<br> **M1 Enclosure plates** A set of plates to close the rear electronic top for the M1 and M1.1 refresh Lever.|none|soon|soon|[CAD](/cad/m1-300-plate.step)|soon | ![alt text](/image/license.png)
### VC400
Product|Status|View|Manual EN|Release date|Shop Product| CAD | STL | License
--------|------|---------------------|----|--------------- |--------------|---------------|---------------|---------------
